...
export default async function handler(req, res) {
  ...
  async function putMethod() {
    ...
    try {
      ...
      console.log(`PUT /api/speakers/${id} status: 500 unexpected`, e);
    }
  }
  ...
  async function postMethod() {
    ...
    try {
      ...
      console.log(`POST /api/speakers/${id} status: 500 unexpected`, e);
    }
  }
  ...
  async function deleteMethod() {
    ...
    try {
      ...
      console.log(`DELETE /api/speakers/${id} status: 500 unexpected`, e);
    }
  }
}
